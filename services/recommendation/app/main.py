...
def startup_event():
    ...
    if db.query(models.Movie).count() == 0:
        dummy_movies = [
            ...
            models.Movie(title="The Shawshank Redemption", genre="Drama", duration_minutes=142, rating=9.3, description="Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.", poster_url="http://example.com/shawshank.jpg"),
            models.Movie(title="The Godfather", genre="Crime", duration_minutes=175, rating=9.2, description="The aging patriarch of an organized crime dynasty transfers control of his clandestine empire to his reluctant son.", poster_url="http://example.com/godfather.jpg"),
            models.Movie(title="Fight Club", genre="Drama", duration_minutes=139, rating=8.8, description="An insomniac office worker and a devil-may-care soapmaker form an underground fight club that evolves into something much, much more.", poster_url="http://example.com/fight_club.jpg"),
            models.Movie(title="Forrest Gump", genre="Drama", duration_minutes=142, rating=8.8, description="The presidencies of Kennedy and Johnson, the events of Vietnam, Watergate and other historical events unfold from the perspective of an Alabama man with an IQ of 75.", poster_url="http://example.com/forrest_gump.jpg"),
            models.Movie(title="The Lord of the Rings: The Fellowship of the Ring", genre="Adventure", duration_minutes=178, rating=8.8, description="A meek Hobbit from the Shire and eight companions set out on a journey to destroy the powerful One Ring and save Middle-earth from the Dark Lord Sauron.", poster_url="http://example.com/lotr.jpg"),
        ]
